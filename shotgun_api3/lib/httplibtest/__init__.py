        ...
        for res in socket.getaddrinfo(self.host, self.port, 0,
            ...
            try:
                if self.proxy_info and self.proxy_info.isgood():
                    ...
                    self.sock.setsockopt(socket.IPPROTO_TCP, socket.TCP_NODELAY, 1)
                # Different from http.client: support timeouts.
                if has_timeout(self.timeout):
                    self.sock.settimeout(self.timeout)
                    # End of difference from http.client.
...
try:
  ...
  class AppEngineHttpConnection(object):
    """Emulates an http.client.HTTPConnection object, but actually uses the Google
...
class Response(dict):
    """An object more like email.message than http.client.HTTPResponse."""
    ...
    def __init__(self, info):
        ...
        # an http.client.HTTPResponse object.
